...
insert into restaurante (id, nome, taxa_frete, cozinha_id, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro, data_hora_cadastro, data_hora_atualizacao, ativo) values (1, 'Churrascaria Batista', 4.0, 1, 1, '53523-100', 'Rua Minas Gerais', '123', null, 'Centro', utc_timestamp, utc_timestamp, 1);
insert into restaurante (id, nome, taxa_frete, cozinha_id, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro, data_hora_cadastro, data_hora_atualizacao, ativo) values (2, 'Restaurante Abaete', 3.0, 1, 1, '53523-160', 'Rua Pio XII', '378', "Andar 2", 'Santa Maria', utc_timestamp, utc_timestamp, 1);
insert into restaurante (id, nome, taxa_frete, cozinha_id, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro, data_hora_cadastro, data_hora_atualizacao, ativo) values (3, 'Thai Foodtruck', 3.0, 2, 1, '78525-090', 'Praça Santuário', '1180', null, 'Centro', utc_timestamp, utc_timestamp, 1);
insert into restaurante (id, nome, taxa_frete, cozinha_id, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro, data_hora_cadastro, data_hora_atualizacao, ativo) values (4, 'Taquitos', 3.0, 3, 1,'45090-080', 'Rua do Peri', '90', null, 'São João', utc_timestamp, utc_timestamp, 1);
